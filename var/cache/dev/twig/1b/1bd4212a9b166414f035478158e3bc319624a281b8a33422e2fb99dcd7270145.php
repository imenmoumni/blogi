...
class __TwigTemplate_98267aa44869f13503c099b5ff0c8344e5a605a9e48ad0704982857dcddbb152 extends Template
{
    private $source;
    private $macros = [];
  ...
  <h1> 
       ";
        ...
        if ((isset($context["editMode"]) || array_key_exists("editMode", $context) ? $context["editMode"] : (function () { throw new RuntimeError('Variable "editMode" does not exist.', 8, $this->source); })())) {
            // line 9
            echo "       Enregistrer les modifications d'un article !
       ";
        } else {
            // line 11
   ...
   ";
        // line 35
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formArticle"]) || array_key_exists("formArticle", $context) ? $context["formArticle"] : (function () { throw new RuntimeError('Variable "formArticle" does not exist.', 35, $this->source); })()), 'form_end');
        echo "
...
";
    ...
    {
        return array (  131 => 35,  125 => 31,  121 => 29,  117 => 27,  115 => 26,  108 => 22,  104 => 21,  100 => 20,  96 => 19,  90 => 16,  85 => 13,  81 => 11,  77 => 9,  75 => 8,  71 => 6,  61 => 5,  50 => 1,  48 => 3,  35 => 1,);
    }
...
{% endblock %}", "blog/create.html.twig", "/opt/lampp/htdocs/business/templates/blog/create.html.twig");
    }
}
