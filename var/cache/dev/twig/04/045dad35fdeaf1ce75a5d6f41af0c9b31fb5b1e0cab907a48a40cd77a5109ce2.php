...
class __TwigTemplate_30f08c50a61ffeaa1ae78d29dad95b568b823bb92c89915a8e78d33fc33324a7 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<h1> Inscription sur la site </h1>
";
        // line 7
...
";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "username", [], "any", false, false, false, 9), 'row', ["label" => "Nom dutilisateur", "attr" => ["placeholder" => "Nom dutilisateur..."]]);
        echo "
";
        // line 10
...
";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "confirm_password", [], "any", false, false, false, 12), 'row', ["label" => "confirmation du mot du passe", "attr" => ["placeholder" => "répetez votre mot du passe..."]]);
        // line 13
        echo "
...
";
    ...
    {
        return array (  98 => 16,  93 => 13,  91 => 12,  87 => 11,  83 => 10,  79 => 9,  74 => 7,  71 => 6,  61 => 5,  50 => 1,  48 => 3,  35 => 1,);
    }
...
{% block body %}
<h1> Inscription sur la site </h1>
{{form_start(form)}}

{{form_row(form.username, {'label': 'Nom d\\utilisateur','attr':{'placeholder':'Nom d\\utilisateur...'}})}}
{{form_row(form.email, {'label': 'Adresse email','attr':{'placeholder':'Adress email...'}})}}
{{form_row(form.password,{'label': 'mot de passe','attr':{'placeholder':'mot de passe...'}})}}
{{form_row(form.confirm_password,{'label': 'confirmation du mot du passe','attr':
{'placeholder':'répetez votre mot du passe...'}})}}

<button type=\"submit\" class=\"btn btn-success\">Inscription !</button>
{{form_end(form)}}
{% endblock %}", "security/registration.html.twig", "/opt/lampp/htdocs/business/templates/security/registration.html.twig");
    }
}
